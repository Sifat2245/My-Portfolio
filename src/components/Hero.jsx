...
import profileImage from "../assets/photo-removebg.png";
...
const Hero = () => {
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/Sifat2245",
      target: "_blank",
      label: "GitHub",
    },
    {
        ...
        >
          ...
          >
            <p className="text-lg text-[#ffebf3]/80 leading-relaxed max-w-xl blur-text-hover">
              Passionate about crafting modern, responsive web applications that
              blend clean code with engaging user experiences.
            </p>
        ...
        >
          <div className="relative w-[20rem] h-[20rem] md:w-[28rem] md:h-[28rem]">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[calc(100%-24px)] h-[calc(100%-24px)] rounded-full overflow-hidden bg-[#1c1c1c]">
                <img
                  src={profileImage}
            ...
            <motion.svg
              className="absolute inset-0 w-full h-full shadow-xl rounded-full"
              fill="transparent"
              viewBox="0 0 506 506"
